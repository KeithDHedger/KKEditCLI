...
void manageTools(void)
{
	...
	setInfoLabel();
	mainApp->windowColours.foreCol=BACK_BLACK;
	mainApp->windowColours.backCol=BACK_WHITE;
	mainApp->windowColours.useFancy=true;
...
//tools
	...
	manageToolsData.toolList->CTK_drawGadget(true);
